    ...
    <div id="content">
      ...
      <form class="formulario" name="loginAdm" id="loginAdm" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <div class="input-container">
            <i class="fa fa-user icon"></i>
            <input type="text" class="form-control inputs" name="txtLogin" id="txtLogin" placeholder="Usuário"
              required />
          </div>
        ...
        <div class="form-group">
          <div class="input-container">
            ...
            <input type="password" class="form-control inputs" name="txtSenha" id="txtSenha" placeholder="Senha"
              required />
          </div>
        </div>
