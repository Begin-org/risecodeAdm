          ...
          <!-- MENU DE CIMA -->
           ...
           <?php include "menuDeCima.php" ?>
            ...
            <div class="card card-estilizado d-inline-block center-block">
                <div class="card-header header-card-estilizado"><img src="imgs/img-user.jpg" class="mx-auto d-block img-card"></div>
                <div class="card-body">
                    ...
                    <div class="mx-auto d-block" style="margin-top:20px;">
                        <button type="button" class="btn botao-card"><p>Editar</p></button>
                        <button type="button" class="btn botao-card"><p>Excluir</p></button>
                    </div>
